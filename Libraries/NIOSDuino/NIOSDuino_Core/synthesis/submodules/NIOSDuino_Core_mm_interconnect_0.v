...
module NIOSDuino_Core_mm_interconnect_0 (
	...
	wire  [106:0] pio_2_s1_agent_rf_source_data;                                                      // pio_2_s1_agent:rf_source_data -> pio_2_s1_agent_rsp_fifo:in_data
	...
	wire  [106:0] pio_2_s1_agent_rsp_fifo_out_data;                                                   // pio_2_s1_agent_rsp_fifo:out_data -> pio_2_s1_agent:rf_sink_data
	...
	wire  [105:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> pio_2_s1_agent:cp_data
	wire          cmd_mux_008_src_ready;                                                              // pio_2_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [12:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> pio_2_s1_agent:cp_channel
	...
	wire  [105:0] cmd_mux_009_src_data;                                                               // cmd_mux_009:src_data -> pio_1_s1_agent:cp_data
	wire          cmd_mux_009_src_ready;                                                              // pio_1_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire   [12:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> pio_1_s1_agent:cp_channel
	...
	wire  [105:0] cmd_mux_010_src_data;                                                               // cmd_mux_010:src_data -> pio_0_s1_agent:cp_data
	...
	wire  [105:0] cmd_mux_011_src_data;                                                               // cmd_mux_011:src_data -> uart_0_s1_agent:cp_data
	wire          cmd_mux_011_src_ready;                                                              // uart_0_s1_agent:cp_ready -> cmd_mux_011:src_ready
	wire   [12:0] cmd_mux_011_src_channel;                                                            // cmd_mux_011:src_channel -> uart_0_s1_agent:cp_channel
	...
	wire  [105:0] pio_2_s1_agent_rp_data;                                                             // pio_2_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [105:0] pio_1_s1_agent_rp_data;                                                             // pio_1_s1_agent:rp_data -> router_011:sink_data
	...
	wire  [105:0] pio_0_s1_agent_rp_data;                                                             // pio_0_s1_agent:rp_data -> router_012:sink_data
	...
	wire  [105:0] uart_0_s1_agent_rp_data;                                                            // uart_0_s1_agent:rp_data -> router_013:sink_data
	...
	wire          cmd_demux_001_src5_valid;                                                           // cmd_demux_001:src5_valid -> cmd_mux_012:sink1_valid
	wire  [105:0] cmd_demux_001_src5_data;                                                            // cmd_demux_001:src5_data -> cmd_mux_012:sink1_data
	wire          cmd_demux_001_src5_ready;                                                           // cmd_mux_012:sink1_ready -> cmd_demux_001:src5_ready
	wire   [12:0] cmd_demux_001_src5_channel;                                                         // cmd_demux_001:src5_channel -> cmd_mux_012:sink1_channel
	wire          cmd_demux_001_src5_startofpacket;                                                   // cmd_demux_001:src5_startofpacket -> cmd_mux_012:sink1_startofpacket
	wire          cmd_demux_001_src5_endofpacket;                                                     // cmd_demux_001:src5_endofpacket -> cmd_mux_012:sink1_endofpacket
	...
	wire          rsp_demux_012_src1_valid;                                                           // rsp_demux_012:src1_valid -> rsp_mux_001:sink5_valid
	wire  [105:0] rsp_demux_012_src1_data;                                                            // rsp_demux_012:src1_data -> rsp_mux_001:sink5_data
	wire          rsp_demux_012_src1_ready;                                                           // rsp_mux_001:sink5_ready -> rsp_demux_012:src1_ready
	wire   [12:0] rsp_demux_012_src1_channel;                                                         // rsp_demux_012:src1_channel -> rsp_mux_001:sink5_channel
	wire          rsp_demux_012_src1_startofpacket;                                                   // rsp_demux_012:src1_startofpacket -> rsp_mux_001:sink5_startofpacket
	wire          rsp_demux_012_src1_endofpacket;                                                     // rsp_demux_012:src1_endofpacket -> rsp_mux_001:sink5_endofpacket
	...
	wire   [12:0] router_008_src_channel;                                                             // router_008:src_channel -> sdram_controller_0_s1_rsp_width_adapter:in_channel
	...
	wire   [12:0] sdram_controller_0_s1_rsp_width_adapter_src_channel;                                // sdram_controller_0_s1_rsp_width_adapter:out_channel -> rsp_demux_006:sink_channel
	...
	wire   [12:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> sdram_controller_0_s1_cmd_width_adapter:in_channel
	...
	NIOSDuino_Core_mm_interconnect_0_rsp_demux_001 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
